...
images:
  - src: images/img_20200828_114750_5.jpg
    alt: Drinking clean water form the source in Sognefjord, from boat with Captain
      Tor
related_activities:
...
**Environmental Responsibility:** Minimizing your footprint by using low-impact facilities, reducing waste, and avoiding overconsumption.

**Community Support:** Supporting local businesses, using local ingredients and labor, and ensuring that revenues benefit the local community.
...
**Accommodation:** Stay in small, sustainable lodges or hotels that use renewable energy.
